...
A Next.js 13 app-router application that helps users track habit recovery. Features an AI coach (GPT-4o-mini), daily check-ins, and an emergency panic page.
...
app/
  ...
  api/
    chat/route.ts     # POST /api/chat — OpenAI proxy
